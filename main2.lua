...
function findImages()
	...
	os.execute("find midia/images/TUPI/ -name *.jpg > imagelist.txt")
	os.execute("find midia/images/TUPI/ -name *.jpeg >> imagelist.txt")
	os.execute("find midia/images/TUPI/ -name *.bmp >> imagelist.txt")
	os.execute("find midia/images/TUPI/ -name *.gif >> imagelist.txt")
	os.execute("find midia/images/TUPI/ -name *.png >> imagelist.txt")
